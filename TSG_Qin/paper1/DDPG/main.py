...
if __name__ == "__main__":
    ...
    parser.add_argument('--steps_update_interval', default=100, type=int, help='how many episodes to update network')
    parser.add_argument('--episodes_validate_interval', default=200, type=int, help='how many train episodes to perform a validate experiment')
    ...
    #创建输出文件
    output = '/home/zhaoming/RL/Liu_Hua/DDPG/output'
