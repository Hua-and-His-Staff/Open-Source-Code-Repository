...
def get_args():
    ...
    parser.add_argument(
        '--train-seed', type=int, default=100, help='random train seed (default: 1)')
    parser.add_argument(
        '--evaluate-seed', type=int, default=9, help='random evaluate seed (default: 1)')
    parser.add_argument(
        '--num-processes',
        type=int,
        default=8,
    ...
    parser.add_argument(
        '--env-settings',
        default={'privacy_preserving':True,'assign_credit':False,'compared':False},
