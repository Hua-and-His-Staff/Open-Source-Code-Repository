...
from Train_Tanh_Normal_policy_multistep import test
import argparse
...
parser.add_argument('--total-steps', type=int, default=int(1e6), help='total number of steps to train for')
...
if __name__ == '__main__':
    ...
    env_fns=[]
    for i in range(args.num_workers):     env_fns.append(lambda: EIEnv(env_id=22,gamma=args.gamma))
