...
parser.add_argument('--critic-lr', type=float, default=5e-4, help='learning rate')
...
actor_net = Actor(venv.observation_space.shape[0],venv.action_space.shape[0]-30,30)
critic_net = Critic(venv.observation_space.shape[0],venv.action_space.shape[0])
