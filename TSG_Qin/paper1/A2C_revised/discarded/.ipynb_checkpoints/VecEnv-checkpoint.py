...
def ESloss(soc):
    return 26*soc-(soc>0.5)*15*(soc-0.5)**2
...
class EIEnv():
    ...
    def move(self,actions):
        ...
        #obs: t[0], P_pure[1], P_G[2], SOC[3], T_out[4] E_EV[5:5+M]
        #actions: u_G, (P_EV)*M, (u_{AC})*N 
        ...
        costs[0] += 0.5*self.DG_power + 0.0125*self.DG_power**2 
        ...
        if (soc>=1) & (BES_power>0):#弃电免费
            ...
            costs[1] += abs(ESloss(soc)-ESloss(new_soc)) 
